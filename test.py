...
from model.model import OrthFcModel, OrthBiModel

def main(test_list, model_list, args):

    test_dataset = GridTest(test_list[0][0], test_list[0][1], input_shape=(224, 224), bi_flow='clahe')
    ...
    for i in range(len(model_list)):
        ...
        if 'dense' in model_list[i]:
            model = OrthFcModel(model_name='densenet121', pretrained=False, num_classes=2)
...
if __name__ == "__main__":
    ...
    model_list = ['./pth/OrthBi_resnet18_2.pth']
